...
// Get the absolute path to the "misc" directory
$htdocsPath = realpath(dirname(__FILE__));

// Append the relative path to the "navi.json" file
$naviPath = $htdocsPath . '/navi.json';

// Encode Navigation to JSON
$json = json_encode($navigation);

// Write the JSON to the file
file_put_contents($naviPath, $json);
